  ...
  _createClass(Index, [{
    ...
    value: function render() {
      ...
      var data = tasks.map(function (task) {
        return Object(_shared_utility__WEBPACK_IMPORTED_MODULE_14__["updateObject"])(task, {
          created_at: Object(_shared_utility__WEBPACK_IMPORTED_MODULE_14__["convertDate"])(task.created_at),
          action: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
            className: "text-center"
          }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_2__["Link"], {
            to: "/user/tasks/".concat(task.id),
            className: "mx-1"
            ...
            to: "/user/tasks/".concat(task.id, "/edit"),
            className: "mx-1"
          }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_fortawesome_react_fontawesome__WEBPACK_IMPORTED_MODULE_4__["FontAwesomeIcon"], {
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    get: function get(page, show, search) {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_13__["getTasks"](page, show, search));
    },
    "delete": function _delete(id) {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_13__["deleteTasks"](id));
    },
    reset: function reset() {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_13__["resetTasks"]());
    }
  };
};
