  ...
  _createClass(Index, [{
    ...
    value: function render() {
      ...
      var data = admins.map(function (admin) {
        return Object(_shared_utility__WEBPACK_IMPORTED_MODULE_15__["updateObject"])(admin, {
          created_at: Object(_shared_utility__WEBPACK_IMPORTED_MODULE_15__["convertDate"])(admin.created_at),
          photo: admin.photo && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
            className: "d-flex"
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    get: function get(page, show, search) {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_14__["getAdmins"](page, show, search));
    },
    "delete": function _delete(id) {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_14__["deleteAdmins"](id));
    },
