                        ...
                        <Col lg={9} className="border-right">
                            <Row>
                                ...
                                <Col lg={8} className="px-5">
                                    ...
                                    <BetweenButton icon={faArrowAltCircleRight} color="pink" className="rounded-0">
                                        Get a quote
                                    </BetweenButton>
                                </Col>
                                ...
                                <Col lg={8} className="px-5">
                                    ...
                                    <BetweenButton icon={faArrowAltCircleRight} color="pink" className="mr-4 rounded-0">
                                        Read More
                                    </BetweenButton>
                                    <BetweenButton icon={faArrowAltCircleRight} color="green" className="rounded-0">
                                        Download PDF
                                    </BetweenButton>
                                </Col>
                            </Row>
